                                ...
                                <div wire:ignore class="flex flex-nowrap items-center gap-1">
                                    <template x-for="(option, index) in selectedOptions" :key="`selected.${index}`">
                                        <span
                                            ...
                                            <span style="" class="" x-text="option.label"></span>
                                            {{-- Nuevo: button para search datos  --}}
                                            <button
                                                class="shrink-0 h-4 w-4 flex items-center text-red-600y-400 justify-center hover:text-secondary-500"
                                                @click="{{ route('livewire_dashboard') }}" tabindex="-1" type="button">
